...
export class TypeOrmPlayRepository implements PlayRepository {
  ...
  private toDomain(entity: PlayEntity): Play {
    ...
    return new Play({
      ...
      prizeMultiplier: entity.prizeMultiplier ? Number(entity.prizeMultiplier) : undefined,
      potentialPrize: entity.potentialPrize ? Number(entity.potentialPrize) : undefined,
      actualPrize: entity.actualPrize ? Number(entity.actualPrize) : undefined,
