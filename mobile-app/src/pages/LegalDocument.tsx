...
const LegalDocument: React.FC = () => {
  ...
  const formatMarkdown = (markdown: string): string => {
    return markdown
      ...
      .replace(/^## (.*$)/gim, '<h2 style="font-size: 20px; font-weight: 700; margin: 32px 0 16px 0; color: var(--ion-color-dark);">$1</h2>')
      ...
      // Links
      .replace(/\[(.*?)\]\((.*?)\)/gim, '<a href="$2" style="color: var(--ion-color-primary); text-decoration: underline;">$1</a>')
      // Paragraphs
